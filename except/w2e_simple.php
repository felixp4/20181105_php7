...
function suffer()
{
    // Создаем новый объект-перобразователь. Начиная с этого момента
    ...
    try {
        ...
        // Перехватываем исключение типа E_WARNING
        echo "<pre><b>Перехвачена ошибка!\n</b>", $e, "</pre>";
    }
    ...
    // при выходе из функции (при этом вызовется деструктор объекта $w2e,
