...
// Выводим количество файлов и подкаталгов
echo "Каталог $dirname содержит $file_count файлов и $dir_count подкаталогов<br />";

// Устанавливаем указатель каталогов в начало
$cat->rewind();
