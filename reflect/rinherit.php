...
// Класс с единственным закрытым совйством
class Base
{
    private $prop = 0;
...
// Распечатываем значения свойстви убеждаемся, что они не пересекаются
...
// Распечатываем значения свойств по умолчанию
var_dump($cls->getDefaultProperties());